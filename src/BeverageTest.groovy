class BeverageTest extends GroovyTestCase {
    ...
    void testGetDescription() {
        ...
        assertEquals("Dark Roast, plus Milk", new WithMilk(new DarkRoast()).getDescription())
        assertEquals("Dark Roast, plus Mocka", new WithMocka(new DarkRoast()).getDescription())
        assertEquals("Dark Roast, plus Milk, plus Mocka", new WithMocka(new WithMilk(new DarkRoast())).getDescription())
        assertEquals("Dark Roast, plus Milk, plus Mocka, plus Mocka", new WithMocka(new WithMocka(new WithMilk(new DarkRoast()))).getDescription())
        assertEquals("Mid Dark Roast, plus Milk, plus Mocka, plus Mocka", new Mid(new WithMocka(new WithMocka(new WithMilk(new DarkRoast())))).getDescription())}
