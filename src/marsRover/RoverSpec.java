...
* You are given the initial starting point (pX,pY) of a rover and the direction (N,S,E,W) it is facing.
...
public class RoverSpec {
    ...
    public void newInstanceShouldSetRoverCoordinatesAndDirection() {
        Assertions.assertThat(rover.getCoordinates()).isEqualToComparingFieldByField(roverCoordinates);
    }
    ...
    public void receiveSingleCommandShouldMoveForwardWhenCommandIsF() throws Exception {
        ...
        Assertions.assertThat(rover.getCoordinates().getPy().getLocation()).isEqualTo(expected);
    }
    ...
    public void receiveSingleCommandShouldTurnLeftWhenCommandIsL() throws Exception {
        ...
        Assertions.assertThat(rover.getCoordinates().getDirection()).isEqualTo(Direction.WEST);
    }

    @Test
    public void receiveSingleCommandShouldTurnRightWhenCommandIsR() throws Exception {
        rover.receiveSingleCommand('R');
        Assertions.assertThat(rover.getCoordinates().getDirection()).isEqualTo(Direction.EAST);
    }
    ...
    public void receiveCommandsShouldBeAbleToReceiveMultipleCommands() throws Exception {
        ...
        Assertions.assertThat(rover.getCoordinates().getPx().getLocation()).isEqualTo(expected);
        Assertions.assertThat(rover.getCoordinates().getDirection()).isEqualTo(Direction.SOUTH);
    }

    @Test
    public void receiveCommandShouldJmumpFromOneEdgeOfTheGridToAnother() throws Exception {
